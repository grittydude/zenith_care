...
mixin _$AppUser {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, email, fullName, phone, avatarUrl, isEmailVerified);

  @override
  String toString() {
    return 'AppUser(id: $id, email: $email, fullName: $fullName, phone: $phone, avatarUrl: $avatarUrl, isEmailVerified: $isEmailVerified)';
  }
}
...
extension AppUserPatterns on AppUser {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String email, String? fullName, String? phone,
            String? avatarUrl, bool isEmailVerified)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AppUser() when $default != null:
        return $default(_that.id, _that.email, _that.fullName, _that.phone,
            _that.avatarUrl, _that.isEmailVerified);
      case _:
        return orElse();
    }
  }
